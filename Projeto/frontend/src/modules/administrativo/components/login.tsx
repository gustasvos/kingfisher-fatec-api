            ...
            <div className="bg-[#EAF7FF] flex justify-center items-center ">
                <div className="bg-[#015084] w-[280px] md:w-[400px] h-[350px] md:h-[500px] p-4 rounded-[5px] md:rounded-[10px] flex justify-center drop-shadow-[2px_2px_3px_rgba(1,80,132,0.8)]">
                    <form action="">
                        ...
                        <IMaskInput mask={"000.000.000-00"}  placeholder=" Digite sue CPF" required maxLength={14} className="w-[200px] md:w-[300px] h-[25px] md:h-[45px] rounded-[10px] md:rounded-[15px] shadow-[4px_4px_4px_rgba(0,0,0,0.4)] outline-[#053657]"/>
                        ...
                        <input type="password" placeholder=" Digite sua senha" required className="w-[200px] md:w-[300px] h-[25px] md:h-[45px] rounded-[10px] md:rounded-[15px] shadow-[4px_4px_4px_rgba(0,0,0,0.4)] outline-[#053657]"/>
