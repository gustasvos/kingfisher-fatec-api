                    ...
                    >
                        <Container>
                            ...
                            <form onSubmit={isPendente ? formEnviado : (e) => e.preventDefault()}
                                className="grid grid-cols-1 md:grid-cols-[58%,2%,40%] grid-rows-auto md:grid-rows-[35%,2%,63%] h-full  rounded-[15px]  text-black gap-4 p-4 overflow-hidden">
                                {/* --- ESQUERDA --- */}
                                ...
                                <span className="hidden md:block row-start-2 w-full h-[2px] bg-[#C2E8FF]" />

                                <section className="md:row-start-3 pt-[15px] pl-[20px]">
                                ...
                                <span className="hidden md:block row-start-1 row-span-3 w-[2px] h-full bg-[#C2E8FF]" />

                                {/* --- DIREITA (CONFIRMAÇÃO/STATUS) --- */}
                                <section className=" flex flex-col items-center relative  md:col-start-3  md:row-span-3  pt-[30px]  space-y-5 w-full">
